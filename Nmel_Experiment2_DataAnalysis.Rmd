...
SampleSize <- c(17,23)
tx_table <- cbind(tx, description, SampleSize)
colnms <- c("Treatment", "Description", "Sample Size")
kable(tx_table, col.names = colnms, align=c('c', 'l', 'c'), caption = "Treatment code (tx number), description, and samples sizes per treatment.")
```
...
```{r assign factors}
propdata$tx <- factor(propdata$tx)
